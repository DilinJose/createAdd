...
const MediaAdsForm = () => {
  ...
  const validationSchema = Yup.object({
    ...
    landscapeimg: Yup.string().required("Required"),
    portraitimg: Yup.string().required("Required"),
    squareimg: Yup.string().required("Required"),
      ...
      >
        <Form>
          <div style={{}} className="mx-3 mb-3 text-media-card">
            ...
            <div className="d-flex">
              <div className="mb-3 img-field">
                <label className="form-label" htmlFor="landscapeimg">
              ...
              <div className="mb-3 img-field">
                <label className="form-label" htmlFor="portraitimg">
              ...
              <div className="mb-3 img-field">
                <label className="form-label" htmlFor="squareimg">
